...
public class WalletService {
    ...
    @Transactional(readOnly = true)
    public Wallet getByUserIdWithoutLock(Long userId) {
        return walletRepository.findByUserId(userId)
                .orElseThrow(() -> new AppException.WalletNotFoundException(userId));
    }

    @Transactional(readOnly = true)
    public Wallet getByIdWithoutLock(Long walletId) {
        return walletRepository.findById(walletId)
                .orElseThrow(() -> new AppException.WalletNotFoundException(walletId));
    }
